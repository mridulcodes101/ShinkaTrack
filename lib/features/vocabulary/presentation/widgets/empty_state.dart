...
class VocabularyEmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String subtitle = isUserCollection
        ? "You haven't added any vocabulary to your collection yet. Start browsing now!"
        : "Vocabulary will appear once content has been added. Developer Mode can create entries.";
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Icon(
                isUserCollection ? Icons.book_rounded : Icons.library_books_rounded,
                size: 72,
