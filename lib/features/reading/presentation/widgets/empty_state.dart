...
class ReadingEmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String subtitle = isUserCollection
        ? "You haven't bookmarked any reading passages yet. Start browsing now!"
        : "Reading passages will appear after content is added.";
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Icon(
                isUserCollection ? Icons.bookmark_outline_rounded : Icons.menu_book_rounded,
                size: 72,
